...
class ShipView(BaseView):
    ...
    def add_sub_view(self, sub_view):
        ...
        sub_view.model.observe(self.remove_sub_view_for_model_callback, "alive")
    ...
    def remove_sub_view_for_model_callback(self, caller):
        self.remove_sub_view_for_model(caller)
